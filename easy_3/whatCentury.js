...
// let spreadYears = year.reduce((acc, cur) => acc + cur, 0);

// // console.log(spreadYears)

// let centuries = Math.ceil(spreadYears/100);
...
// The exception to this is when the year is a multiple of 100. In that case, the century is the current year divided by 100.
...
// But before doing that, it does one extra check. If the remainder of dividing the century by 100 ends in either 11, 12, or 13, 
// the solution returns 'th'. Any other time, it returns a suffix determined by the switch statement and the value of 
// centuryNumber % 10.
